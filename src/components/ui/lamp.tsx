...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background w-full z-0 pt-20",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-transparent via-transparent to-yellow-400 text-white [--conic-position:from_290deg_at_center_top]"
        >
      ...
      <div className="relative z-50 flex -translate-y-20 flex-col items-center px-5 w-full max-w-7xl mx-auto">
        {children}
      </div>
    </div>
  );
