  ...
  return (
    <section id="hero" className="relative overflow-hidden">
      <WavyBackground 
        ...
        waveOpacity={0.3}
      >
        <div className="container mx-auto grid lg:grid-cols-2 gap-8 md:gap-12 items-center w-full px-4 sm:px-8 md:px-12 lg:px-20 min-h-screen pt-20">
          {/* Left Content */}
          <motion.div
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.5 }}
            className="text-center lg:text-left space-y-6 md:space-y-8 lg:pl-12">
